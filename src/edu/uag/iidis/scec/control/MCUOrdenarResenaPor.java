...
public final class MCUOrdenarResenaPor
        extends MappingDispatchAction {

    private Log log = LogFactory.getLog(MCURegistrarUsuario.class);


    public ActionForward SolicitarOrdenarResena(
        ...
        if (log.isDebugEnabled()) {
            log.debug(">SolicitarOrdenarResenas");
        }
        ...
        Collection resultado = mr.ordenarResenasPor(forma.getNombre());
        if (log.isDebugEnabled()) {
	 ...
	 public ActionForward buscarResena(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
