...
public class ManejadorRestaurantees {
    private Log log = LogFactory.getLog(ManejadorRestaurantees.class);
    private RestauranteDAO restauranteDAO;

    public ManejadorRestaurantees() {
        restauranteDAO = new RestauranteDAO();
    }


    public Collection listarRestaurantees() {
    ...
    public Collection ordenarRestauranteesPor(String attribute) {
        Collection resultado;
        ...
        try {
            HibernateUtil.beginTransaction();
            resultado = restauranteDAO.ordenarRestauranteesPor(attribute);
            if (log.isDebugEnabled()) {
	...
	public Collection listarRestauranteesPorNombre(String nombre) {
        Collection resultado;
    ...
    public void eliminarRestaurante(Long id) {
        if (log.isDebugEnabled()) {
            log.debug(">eliminarRestaurante(restaurante)");
        }
        try {
            HibernateUtil.beginTransaction();
    ...
    public int crearRestaurante(Restaurante restaurante) {
        ...
        if (log.isDebugEnabled()) {
            log.debug(">guardarRestaurante(restaurante)");
        }
