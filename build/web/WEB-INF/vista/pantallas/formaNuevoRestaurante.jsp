...
<br>
<font size='5'><fmt:message key="formaNuevoRestaurante.titulo" /></font>

<form id="forma" action="procesarRegistroRestaurante.do" method="post" enctype="multipart/form-data">
    <table>
        <tr>
            <td colspan="2">
               <html:errors />
        ...
        <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.nombre" />
            </td>
            ...
            <td align="left">
                <input type="text"
                       ...
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.nombre}" />
            </td>
        </tr>
        <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.descripcion" />
            </td>
            <td align="left">
                <input type="text"
                       name="descripcion"
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.descripcion}" />
            </td>
        </tr>
  <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.precio" />
            </td>
            <td align="left">
                <input type="number"
                       name="precio"
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.precio}" />
            </td>
        </tr>
       <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.horario" />
            </td>
            <td align="left">
                <input type="text"
                       name="horario"
                       ...
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.horario}" />
            </td>
        </tr>
        <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.estado" />
            </td>
            <td align="left">
                <input type="text"
                      id="estado"
                      name="estado"
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.estado}"/>
            </td>
        </tr>
        <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.pais" />
            </td>
            <td align="left">
                <input type="text"
                      id="pais"
                      name="pais"
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.pais}"/>
            </td>
        </tr>
        <tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.direccion" />
            </td>
            <td align="left">
                <input type="text"
                      id="direccion"
                      name="direccion"
                       size="50"
                       maxlength="100"
                       value="${formaNuevoRestaurante.direccion}"/>
            </td>
        </tr>
         <!--<tr>
            <td align="right">
                <fmt:message key="formaNuevoRestaurante.etiqueta.buscaestado" />
            </td>
            <td align="left">
                <input type="text"
           id="est"
  ...
  <!--<tr align="center">
    ...
    <td align="left">
      <select id="listaE" name="estado" required>
        ...
        <c:forEach var="estado" items="${formaNuevoRestaurante.estados}">
          <option value='<c:out value="${restaurante.nombre}"/>'><c:out value="${estado.nombre}"/></option>
        </c:forEach>
      </select>
    </td>
    </tr>-->
